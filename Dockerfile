...
RUN curl -sLH "Cookie: oraclelicense=accept-securebackup-cookie" \
    http://download.oracle.com/otn-pub/java/jdk/8u151-b12/e758a0de34e24606bca991d704f6dcbf/jre-8u151-linux-x64.tar.gz \
    | tar -xzf - -C /opt \
...
RUN curl -o /tmp/adito.tar "http://static.adito.de/common/install/ADITO5/ADITO_5.0.120-RC7_unix.tar" \
